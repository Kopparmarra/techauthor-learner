...
function makeDrill(spec){
 ...
 if(k==="select"){
   ...
   d.setup=()=>{
     ...
     m.initialLeftMode="document";
     m.initialDocumentMapHidden=false;
...
function loadCurrentDrill(){
 ...
 const hintMap={
   ...
   shortcut:d.skill==="shortcut"&&d.prompt.includes("Document Map")?"Resources is shown first. Use the shortcut to return to Document Map.":"Use the keyboard shortcut named in the task.",
